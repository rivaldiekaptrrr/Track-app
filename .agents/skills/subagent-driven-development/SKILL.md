...
digraph process {
    ...
    subgraph cluster_per_task {
        ...
        "Any load-bearing findings?" [shape=diamond];
    ...
    "Adjudicate each open finding" -> "Any load-bearing findings?";
    "Any load-bearing findings?" -> "Rule and continue; stop only if every path forward is a guess" [label="yes"];
    "Any load-bearing findings?" -> "Park findings in ledger with rulings" [label="no"];
